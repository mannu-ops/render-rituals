...
export default function AdminProjectsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ========================================================= */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-2 xs:p-3 sm:p-4 backdrop-blur-md overflow-y-auto">
          <div className="relative w-full max-w-3xl rounded-2xl sm:rounded-3xl border border-white/15 bg-[#1E2227] p-4 xs:p-5 sm:p-7 shadow-2xl my-2 sm:my-6 max-h-[94vh] overflow-y-auto flex flex-col justify-between">
            <div>
              {/* Modal Header */}
              <div className="flex items-center justify-between border-b border-white/10 pb-3 sm:pb-4">
                <div className="pr-2">
                  <h2 className="font-display text-base xs:text-lg sm:text-xl font-semibold text-[#F3F4F6]">
                    {editingProject ? "Edit Project Suite (3D + 2D)" : "Add New Project Suite"}
                  </h2>
                  <p className="text-[10px] xs:text-xs text-[#8E98A5] mt-0.5">
                ...
                <button
                  ...
                  className="flex h-7 w-7 sm:h-8 sm:w-8 shrink-0 items-center justify-center rounded-full border border-white/10 text-[#8E98A5] hover:text-[#F3F4F6]"
                >
                  <X size={15} />
                </button>
              </div>

              {/* Modal Step Navigation Pills (Scrollable on Mobile) */}
              <div className="my-3 sm:my-4 flex items-center gap-1.5 sm:gap-2 border-b border-white/10 pb-3 overflow-x-auto scrollbar-none">
                <button
                  type="button"
                  onClick={() => setModalTab("general")}
                  className={`shrink-0 rounded-lg sm:rounded-xl px-2.5 xs:px-3.5 py-1.5 xs:py-2 font-mono-spec text-[9px] xs:text-[10px] sm:text-[10.5px] uppercase tracking-wider transition-all cursor-pointer whitespace-nowrap ${
                    modalTab === "general"
                      ? "bg-[#D49A6A] text-[#14171A] font-bold"
                ...
                <button
                  ...
                  className={`shrink-0 rounded-lg sm:rounded-xl px-2.5 xs:px-3.5 py-1.5 xs:py-2 font-mono-spec text-[9px] xs:text-[10px] sm:text-[10.5px] uppercase tracking-wider transition-all cursor-pointer flex items-center gap-1.5 whitespace-nowrap ${
                    modalTab === "3d"
                      ? "bg-[#D49A6A] text-[#14171A] font-bold"
                      : "bg-[#14171A] text-[#8E98A5] hover:text-[#F3F4F6]"
                  }`}
              ...
              {modalTab === "general" && (
                <div className="space-y-3.5">
                  ...
                  <div className="grid gap-2.5 sm:grid-cols-2">
                    ...
                    <div className="flex items-center justify-between rounded-xl sm:rounded-2xl border border-white/10 bg-[#14171A] p-2.5 xs:p-3 sm:p-4 transition-all hover:border-[#D49A6A]/40">
                      <div className="flex items-center gap-2.5">
                        ...
                        />
                        <div>
                          <p className="font-display text-[11px] xs:text-xs font-semibold text-[#F3F4F6]">
                            {formPublished ? "Published (Live)" : "Draft Mode"}
                          </p>
                          <p className="font-mono-spec text-[8.5px] xs:text-[10px] text-[#8E98A5]">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-5 w-9 xs:h-6 xs:w-11 shrink-0 items-center rounded-full transition-colors cursor-pointer ${
                          formPublished ? "bg-[#25D366]" : "bg-white/20"
                        }`}
                      >
                        <span
                          className={`inline-block h-3.5 w-3.5 xs:h-4 xs:w-4 transform rounded-full bg-[#14171A] transition-transform ${
                            formPublished ? "translate-x-4 xs:translate-x-6" : "translate-x-1"
                          }`}
                        />
                      </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between rounded-xl sm:rounded-2xl border border-white/10 bg-[#14171A] p-2.5 xs:p-3 sm:p-4 transition-all hover:border-[#D49A6A]/40">
                      <div className="flex items-center gap-2.5">
                        <span
                          className={`flex h-5 w-5 xs:h-6 xs:w-6 items-center justify-center rounded-full shrink-0 transition-all ${
                      ...
                      >
                        <span
                          className={`inline-block h-3.5 w-3.5 xs:h-4 xs:w-4 transform rounded-full bg-[#14171A] transition-transform ${
                            formFeatured ? "translate-x-4 xs:translate-x-6" : "translate-x-1"
                          }`}
                        />
                      </button>
                    </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                      <label className="font-mono-spec block text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#D1D5DB] mb-1">
                        Project Title *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full rounded-lg sm:rounded-xl border border-white/10 bg-[#14171A] p-2.5 text-xs text-[#F3F4F6] outline-none focus:border-[#D49A6A]"
                      />
                    </div>
                  ...
                  {/* Master Cover Image */}
                  <div>
                    <label className="font-mono-spec block text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#D1D5DB] mb-1.5">
                      Master Showcase Cover Image
                    </label>

                    {formCoverImage ? (
                      <div className="relative aspect-[16/9] w-full rounded-xl overflow-hidden border border-[#D49A6A]/40 bg-[#14171A] mb-2.5 group">
                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center gap-2">
                          <label className="cursor-pointer inline-flex items-center gap-1.5 rounded-lg bg-[#D49A6A] px-3 py-1.5 text-xs font-bold text-[#14171A] hover:bg-[#E5A97C]">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg bg-rose-500/20 border border-rose-500/40 px-2.5 py-1.5 text-xs font-medium text-rose-400 hover:bg-rose-500/30"
                          >
                            <Trash2 size={12} />
                            <span>Remove</span>
                          </button>
                      ...
                      <label className="border-2 border-dashed border-white/20 hover:border-[#D49A6A] bg-[#14171A] hover:bg-[#14171A]/80 transition-all rounded-xl p-4 sm:p-6 flex flex-col items-center justify-center cursor-pointer mb-2.5 group">
                        <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-[#D49A6A]/10 border border-[#D49A6A]/30 flex items-center justify-center text-[#D49A6A] mb-2 group-hover:scale-110 transition-transform">
                          {isUploading ? <Loader2 size={18} className="animate-spin" /> : <Upload size={18} />}
                        </div>
                        <p className="font-display text-[11px] sm:text-xs font-semibold text-[#F3F4F6] text-center">
                          {isUploading ? "Uploading 4K Render to Cloudinary..." : "Click to Upload Cover Image from Computer"}
                        </p>
                        <p className="font-mono-spec text-[8.5px] sm:text-[9px] uppercase tracking-wider text-[#8E98A5] mt-1 text-center">
              ...
              {modalTab === "3d" && (
                <div className="space-y-3.5">
                  <div className="rounded-xl sm:rounded-2xl border border-white/10 bg-[#14171A] p-3 sm:p-4">
                    <p className="font-display text-xs sm:text-sm font-semibold text-[#D49A6A] mb-2.5">
                      Current 3D Render Perspectives ({form3DRenders.length})
                    </p>

                    {form3DRenders.length === 0 ? (
                      <p className="font-mono-spec text-[9.5px] sm:text-[10px] text-[#8E98A5] py-3 text-center">
                      ...
                      <div className="space-y-2 max-h-48 sm:max-h-56 overflow-y-auto pr-1">
                        {form3DRenders.map((r, idx) => (
                          <div
                            key={r.id || idx}
                            className="flex items-center justify-between rounded-lg sm:rounded-xl border border-white/5 bg-[#1E2227] p-2.5"
                          >
                            <div className="flex items-center gap-2.5 truncate">
                              <img src={r.image} alt={r.title} onError={handleImageError} className="h-9 w-12 rounded object-cover border border-white/10 shrink-0" />
                              <div className="truncate">
                                <p className="font-display text-xs font-semibold text-[#F3F4F6] truncate">{r.title}</p>
                                <p className="font-mono-spec text-[8.5px] text-[#D49A6A] mt-0.5">{r.tag || "4K Render"}</p>
                              </div>
                            </div>
                            ...
                            <button
                              ...
                              className="text-[#8E98A5] hover:text-[#EF4444] p-1 shrink-0 cursor-pointer"
                            >
                              <Trash2 size={13} />
                            </button>
                          </div>
                  ...
                  <div className="rounded-xl sm:rounded-2xl border border-[#D49A6A]/30 bg-[#14171A] p-3 sm:p-4 space-y-2.5">
                    <p className="font-mono-spec text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#D49A6A]">
                    ...
                    <div className="grid gap-2.5 sm:grid-cols-2">
                      <input
                        ...
                        className="rounded-lg sm:rounded-xl border border-white/10 bg-[#1E2227] p-2.5 text-xs text-[#F3F4F6] outline-none focus:border-[#D49A6A]"
                      />
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2.5 items-center">
                      {new3DImage ? (
                        <div className="h-14 w-20 rounded-lg overflow-hidden border border-[#D49A6A]/40 shrink-0">
                          <img src={new3DImage} alt="Preview" onError={handleImageError} className="h-full w-full object-cover" />
                        </div>
                      ) : null}

                      <label className="flex-1 w-full border border-dashed border-[#D49A6A]/40 hover:bg-[#D49A6A]/10 transition-all rounded-lg sm:rounded-xl p-2.5 sm:p-3 flex items-center justify-center gap-2 cursor-pointer">
                        {isUploading ? <Loader2 size={13} className="animate-spin text-[#D49A6A]" /> : <Upload size={13} className="text-[#D49A6A]" />}
                    ...
                    <input
                      ...
                      className="w-full rounded-lg sm:rounded-xl border border-white/10 bg-[#1E2227] p-2 text-xs text-[#F3F4F6] outline-none focus:border-[#D49A6A]"
                    />

                    <button
                      type="button"
                      onClick={handleAdd3D}
                      className="w-full rounded-lg sm:rounded-xl bg-[#D49A6A] py-2.5 text-xs font-bold text-[#14171A] hover:bg-[#E5A97C] cursor-pointer"
                    >
              ...
              {modalTab === "2d" && (
                <div className="space-y-3.5">
                  <div className="rounded-xl sm:rounded-2xl border border-white/10 bg-[#14171A] p-3 sm:p-4">
                    <p className="font-display text-xs sm:text-sm font-semibold text-[#F3F4F6] mb-2.5">
                    ...
                    {form2DPlans.length === 0 ? (
                      ...
                      <div className="space-y-2 max-h-48 sm:max-h-56 overflow-y-auto pr-1">
                        {form2DPlans.map((p, idx) => (
                          ...
                          >
                            <div className="flex items-center gap-2.5 truncate">
                              <img src={p.image} alt={p.title} onError={handleImageError} className="h-9 w-12 rounded object-contain bg-[#0F1113] border border-white/10 shrink-0" />
                              <div className="truncate">
                                <p className="font-display text-xs font-semibold text-[#F3F4F6] truncate">{p.title}</p>
                                <p className="font-mono-spec text-[8.5px] text-[#8E98A5] mt-0.5">{p.sheetType} · Scale {p.scale || "1:50"}</p>
                              </div>
                            </div>
                  ...
                  <div className="rounded-xl sm:rounded-2xl border border-white/20 bg-[#14171A] p-3 sm:p-4 space-y-2.5">
                    <p className="font-mono-spec text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#F3F4F6]">
                    ...
                    <div className="grid gap-2.5 sm:grid-cols-3">
                      <input
                        ...
                        className="rounded-lg sm:rounded-xl border border-white/10 bg-[#1E2227] p-2.5 text-xs text-[#F3F4F6] outline-none focus:border-[#D49A6A] sm:col-span-2"
                      />
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2.5 items-center">
                      {new2DImage ? (
                        <div className="h-14 w-20 rounded-lg overflow-hidden border border-white/20 bg-[#0F1113] p-1 shrink-0">
                          <img src={new2DImage} alt="Preview" onError={handleImageError} className="h-full w-full object-contain" />
                        </div>
                      ) : null}

                      <label className="flex-1 w-full border border-dashed border-white/30 hover:bg-white/5 transition-all rounded-lg sm:rounded-xl p-2.5 sm:p-3 flex items-center justify-center gap-2 cursor-pointer">
                        {isUploading ? <Loader2 size={13} className="animate-spin text-white" /> : <Upload size={13} className="text-white" />}
                        <span className="text-xs font-semibold text-[#F3F4F6]">
            ...
            <div className="mt-5 sm:mt-6 flex flex-col xs:flex-row items-center justify-between gap-3 border-t border-white/10 pt-3.5 sm:pt-4">
              <div className="font-mono-spec text-[9px] xs:text-[10px] text-[#8E98A5] text-center xs:text-left">
              ...
              <div className="flex items-center gap-2 sm:gap-3 w-full xs:w-auto justify-end">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 xs:flex-initial rounded-lg sm:rounded-xl border border-white/10 px-4 py-2 sm:px-5 sm:py-2 text-xs font-medium text-[#8E98A5] hover:text-[#F3F4F6] cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="button"
                  onClick={handleSave}
                  className="flex-1 xs:flex-initial inline-flex items-center justify-center gap-1.5 rounded-lg sm:rounded-xl bg-[#D49A6A] px-4 py-2 sm:px-5 sm:py-2 text-xs font-bold uppercase tracking-wider text-[#14171A] shadow-md hover:bg-[#E5A97C] cursor-pointer whitespace-nowrap"
                >
                  <Check size={13} />
                  <span>{editingProject ? "Update Suite" : "Save & Publish"}</span>
                </button>
              </div>
            </div>
          </div>
